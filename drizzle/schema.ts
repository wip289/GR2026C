...
export const jobseekers = mysqlTable("jobseekers", {
  ...
  nik: varchar("nik", { length: 20 }).default(""),
  tempatLahir: varchar("tempatLahir", { length: 100 }),
  tanggalLahir: date("tanggalLahir"),
  jenisKelamin: mysqlEnum("jenisKelamin", ["Laki-laki", "Perempuan", "Tidak Diisi"]).default("Tidak Diisi"),
  whatsapp: varchar("whatsapp", { length: 20 }).default(""),
  email: varchar("email", { length: 320 }).notNull(),
  kota: varchar("kota", { length: 100 }),
  // Latar belakang
  status: mysqlEnum("status", ["mahasiswa", "fresh_graduate", "alumni_nhi", "umum", "belum_diisi"]).default("belum_diisi"),
