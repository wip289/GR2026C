...
export const jobseekers = mysqlTable("jobseekers", {
  ...
  jenisKelamin: varchar("jenisKelamin", { length: 20 }),
  ...
  tahunLulus: varchar("tahunLulus", { length: 50 }),
  bidangMinat: varchar("bidangMinat", { length: 100 }),
  // Field baru GR2026
  phone: varchar("phone", { length: 20 }),
  minatKerja: varchar("minatKerja", { length: 50 }),
  statusKerja: varchar("statusKerja", { length: 50 }),
