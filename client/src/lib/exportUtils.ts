...
export function exportJobseekersCSV(jobseekers: any[]) {
  ...
  const rows = jobseekers.map((js, i) => {
    ...
    return [
      ...
      js.jurusan || '',
      js.tahunLulus || '',
      js.checkedInDay1At ? 'Ya' : 'Tidak',
      js.checkedInDay1At ? new Date(js.checkedInDay1At).toLocaleString('id-ID', { hour: '2-digit', minute: '2-digit', day: 'numeric', month: 'short', timeZone: 'Asia/Jakarta' }) : '',
      js.checkedInDay2At ? 'Ya' : 'Tidak',
      js.checkedInDay2At ? new Date(js.checkedInDay2At).toLocaleString('id-ID', { hour: '2-digit', minute: '2-digit', day: 'numeric', month: 'short', timeZone: 'Asia/Jakarta' }) : '',
